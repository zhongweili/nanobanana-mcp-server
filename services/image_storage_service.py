...
class ImageStorageService:
    ...
    def store_image(
        ...
        try:
            ...
            self.logger.info(f"Stored image {image_id}: {len(image_bytes)} bytes, expires at {datetime.fromtimestamp(expires_at)}")
            return info
    ...
    def get_storage_stats(self) -> Dict[str, Any]:
        ...
        total_thumbnail_size = sum(info.thumbnail_size_bytes for info in self.image_registry.values())
