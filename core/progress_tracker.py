...
class ProgressTracker:
    ...
    def complete_operation(
        ...
        return self.update_progress(
            operation_id, 100, message, OperationStatus.COMPLETED, details
        )
    ...
    def cancel_operation(
        ...
        """Cancel an operation."""
        return self.update_progress(
            operation_id, -1, message, OperationStatus.CANCELLED
        )
    ...
    def _add_update(
        ...
        self.logger.info(
            f"Progress [{operation.operation_id}]: {progress_percent}% - {message}"
        )
    ...
    def update(
        ...
        if self.operation_id:
            self.tracker.update_progress(
                self.operation_id, progress_percent, message, 
                OperationStatus.RUNNING, details
            )